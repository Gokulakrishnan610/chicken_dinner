...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-warning/5 via-background to-warning/5 flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        {/* Header */}
        <div className="text-center space-y-4">
          <div className="mx-auto w-16 h-16 bg-warning rounded-full flex items-center justify-center">
            <BookOpen className="h-8 w-8 text-warning-foreground" />
          </div>
          <div>
            <h1 className="text-3xl font-bold text-foreground">Faculty Portal</h1>
            <p className="text-muted-foreground mt-2">Review and manage student submissions</p>
          </div>
        </div>
        ...
        <div className="text-center text-sm text-muted-foreground">
          <p>Faculty access only. Contact IT support for assistance.</p>
        </div>
      </div>
    </div>
  );
